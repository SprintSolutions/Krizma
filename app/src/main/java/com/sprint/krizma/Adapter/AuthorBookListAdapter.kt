...
class AuthorBookListAdapter

(internal var context: Context, internal var books: ArrayList<Book>) : RecyclerView.Adapter<AuthorBookListAdapter.BookViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookViewHolder {
        ...
        return AuthorBookListAdapter.BookViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        holder.favourite.setOnClickListener{
            if(book.favourite_flag==0) {
                addToFavourite(book.b_id, holder.favourite, holder.progress, position, book)
            }
            else if(book.favourite_flag==1) {
    ...
    fun addToFavourite(id:Int, image:ImageView, progress: ProgressBar, index: Int, book:Book) {
        ...
        val url = "http://sprintsols.com/krizma/public/addFavouriteBook"
        val postRequest = object : JsonObjectRequest(Request.Method.POST, url, request,
                Response.Listener<JSONObject> { response ->
                    ...
                    if (code == 101) {
                        ...
                        book.favourite_flag = 1
                        Utils.favouriteBooks.add(books[index])

                        Toast.makeText(context,"Book has been added into your favourites.",Toast.LENGTH_SHORT).show()
        ...
        val postRequest = object : JsonObjectRequest(Request.Method.POST, url, request,
                Response.Listener<JSONObject> { response ->
                    ...
                    if (code == 101) {
                        ...
                        Toast.makeText(context,"Book has been removed from your favourites.",Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(context, "something went wrong", Toast.LENGTH_LONG).show()
                    }
