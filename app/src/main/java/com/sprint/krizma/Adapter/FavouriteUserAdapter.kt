...
(internal var context: Context, internal var users: ArrayList<User>) : RecyclerView.Adapter<FavouriteUserAdapter.FavouriteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: FavouriteViewHolder, position: Int) {
        ...
        holder.distance.text = user.u_distance
        holder.gender.text = user.u_gender
        holder.location.text = user.u_country
        ...
        Glide.with(context).load(user.u_avatar).into(holder.profile)
        ...
        holder.list_data.setOnClickListener {
            ...
            intent.putExtra("Genre",user.u_gender)
